...
def draw_plot(malleable1, malleable2, malleable3, label, name):
    ...
    ax.plot(perc, malleable1, linewidth=3, marker=".", markersize=14, label="system")
    ax.plot(perc, malleable2, linewidth=3, marker=".", markersize=14, color='r', label="application")
    ax.plot(perc, malleable3, linewidth=3, marker=".", markersize=14, color='g', label="both")
    ...
    # plt.show()
    name = "unit_test/comparison/time/" + name + ".png"
    plt.savefig(name)
    return
...
def main():
    ...
    for i in range(10, 110, 10):
        location = "unit_test/result_application/time/mal/" + "average_mal" + str(i) + ".txt"
    ...
    for i in range(10, 110, 10):
        location = "unit_test/result_system/time/mal/" + "average_mal" + str(i) + ".txt"
    ...
    draw_plot(turn_around_time, turn_around_time2,turn_around_time3, "Average Turnaround Time",
              "Turnaround time")
    draw_plot(wait_time, wait_time2, wait_time3, "Average wait Time",
              "wait time")
    draw_plot(span, span2, span3, "Span",
              "span")
    draw_plot(utilization, utilization2, utilization3, "Utilization",
              "utilization")
    draw_plot(exe, exe2, exe3, "Average Execution Time",
              "execution")
